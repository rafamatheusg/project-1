...
Each document is split on `Review N:` markers, one chunk per review. Reviews are self contained opinion units that can answer a question on their own. Splitting by fixed character count would break sentences mid thought and lose meaning.

- Chunk size: 300–500 characters
- Overlap: reviews are independent
